	...
	$(function() {
     ...
     <div class="slider_container">
		<div class="flexslider">
	      <ul class="slides">
	    	<li>
	    		<a href="#"><img src="images/slider/slide1.jpg"  height="600" width="1550" alt="" title=""/></a>
	    	...
	    	<li>
	    		<a href="#"><img src="images/slider/slide2.jpg" height="600" width="1550"  alt="" title=""/></a>
	    		<div class="flex-caption">
	    	...
	    	<li>
	    		<a href="#"><img src="images/slider/slide3.jpg" height="600" width="1550"  alt="" title=""/></a>
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Controled By Admin</h2><p>Everying is managed and controled by administrator</p></div>
                </div>
	    	</li>
	    	<li>
				<a href="#"><img src="images/slider/slide4.jpg" height="600" width="1550"  alt="" title=""/></a>
	    		<div class="flex-caption">
